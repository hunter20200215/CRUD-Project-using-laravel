...
<head>
  ...
  <!-- MDB icon -->
  <link rel="icon" href="https://img.icons8.com/color/2x/3ds-max.png" type="image/x-icon">
  <!-- Font Awesome -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link waves-effect" href="aboutus" target="_blank">About Us</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link waves-effect" href="contactus" target="_blank">contact me</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link waves-effect" href="faqs_page" target="_blank">FAQ</a>
                        </li>
                    </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-4">
                        ...
                        <div class="card mb-3 wow fadeIn">
                            <div class="card-header font-weight-bold">Post Blog</div>
                            <div class="card-body">
