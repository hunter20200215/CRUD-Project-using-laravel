				...
				<form action="{{route('admin.posts.store')}}" method="post">
					...
					<div class="form-group">
				  	...
				  	<div class="form-group">
					    ...
					    <input type="text" class="form-control @error('subject') invalid @enderror" id="subject" aria-describedby="subjectHelp" placeholder="Enter Subject" name="subject" value="{{ old('subject') }}">
				  	...
				  	<div class="form-group">
					    <label for="intro">Introduction<span class="required">*</span></label>
					    <textarea class="form-control" id="intro" name="intro">{{ old('intro') }}</textarea>
				  	...
				  	<div class="form-group">
					    ...
					    <textarea class="form-control" id="content" name="description[content]" rows="10">{{ old('description.content') }}</textarea>
